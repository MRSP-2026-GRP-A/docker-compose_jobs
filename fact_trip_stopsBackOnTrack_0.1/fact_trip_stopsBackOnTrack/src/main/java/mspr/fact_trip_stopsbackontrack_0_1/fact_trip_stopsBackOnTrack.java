...
package mspr.fact_trip_stopsbackontrack_0_1;
...
public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
    final static byte[] commonByteArrayLock_MSPR_fact_trip_stopsBackOnTrack = new byte[0];
    static byte[] commonByteArray_MSPR_fact_trip_stopsBackOnTrack = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MSPR_fact_trip_stopsBackOnTrack.length) {
				if(length < 1024 && commonByteArray_MSPR_fact_trip_stopsBackOnTrack.length == 0) {
   					commonByteArray_MSPR_fact_trip_stopsBackOnTrack = new byte[1024];
				} else {
   					commonByteArray_MSPR_fact_trip_stopsBackOnTrack = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MSPR_fact_trip_stopsBackOnTrack, 0, length);
			strReturn = new String(commonByteArray_MSPR_fact_trip_stopsBackOnTrack, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MSPR_fact_trip_stopsBackOnTrack) {
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_2 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_2.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:yU9OT2z5oykWKsVDxOa9cTDSrpzPoMUPHZipXwRGl3vcDlIfI4gPLIgXHcM="));
...
for(int i_tExtractJSONFields_1=0; isStructError_tExtractJSONFields_1 || (i_tExtractJSONFields_1 < resultset_tExtractJSONFields_1.size());i_tExtractJSONFields_1++){
	...
	try {
		jsonPath_tExtractJSONFields_1 = "$.qqa`";
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_1 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_1.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:80RSCTp5lHbpiI6evHgKW7UjNLrF/NXoGnWlMHwEqTt2/JMkwVgzkq4sm6k="));
...
org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties props_tDBInput_1 =
        (org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties) def_tDBInput_1.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:aaXKO0b16xCzA6u6tDxGB0k5Ozg2ug3b5EDDL0Um2Qwa9alI1zEmmehL4fs="));
...
org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties props_tDBInput_2 =
        (org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties) def_tDBInput_2.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:0gpHCJeGq/4QEpbJraZRlwvEQlbMX9h0p01qMgo0YwCFfEga8Co2icQfC7I="));
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = fact_trip_stopsBackOnTrack.class.getClassLoader().getResourceAsStream("mspr/fact_trip_stopsbackontrack_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     236124 characters generated by Talend Open Studio for Data Integration 
 *     on the 27 avril 2026 16:06:13 CEST
 ************************************************************************************************/