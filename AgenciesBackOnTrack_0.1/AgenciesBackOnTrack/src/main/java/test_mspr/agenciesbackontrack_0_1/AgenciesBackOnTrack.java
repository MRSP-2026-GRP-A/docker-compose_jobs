...
package test_mspr.agenciesbackontrack_0_1;
...
/**
 * Job: AgenciesBackOnTrack Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class AgenciesBackOnTrack implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "AgenciesBackOnTrack";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				AgenciesBackOnTrack.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(AgenciesBackOnTrack.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_TEST_MSPR_AgenciesBackOnTrack = new byte[0];
    static byte[] commonByteArray_TEST_MSPR_AgenciesBackOnTrack = new byte[0];
	...
	public void copyDataTo(row5Struct other) {
		...
		other.agency_id = this.agency_id;
	            ...
	            other.agency_logo_url = this.agency_logo_url;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_MSPR_AgenciesBackOnTrack.length) {
				if(length < 1024 && commonByteArray_TEST_MSPR_AgenciesBackOnTrack.length == 0) {
   					commonByteArray_TEST_MSPR_AgenciesBackOnTrack = new byte[1024];
				} else {
   					commonByteArray_TEST_MSPR_AgenciesBackOnTrack = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_MSPR_AgenciesBackOnTrack, 0, length);
			strReturn = new String(commonByteArray_TEST_MSPR_AgenciesBackOnTrack, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_MSPR_AgenciesBackOnTrack) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.agency_logo_url = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.agency_logo_url,dos);
    ...
    public String toString() {
		...
		sb.append(",agency_logo_url="+agency_logo_url);
	    sb.append("]");
...
public static class SelectedStruct implements routines.system.IPersistableRow<SelectedStruct> {
    final static byte[] commonByteArrayLock_TEST_MSPR_AgenciesBackOnTrack = new byte[0];
    static byte[] commonByteArray_TEST_MSPR_AgenciesBackOnTrack = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final SelectedStruct other = (SelectedStruct) obj;
	...
	public void copyDataTo(SelectedStruct other) {
	...
	public void copyKeysDataTo(SelectedStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(SelectedStruct other) {
...
public static class RejectedStruct implements routines.system.IPersistableRow<RejectedStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final RejectedStruct other = (RejectedStruct) obj;
	...
	public void copyDataTo(RejectedStruct other) {
	...
	public void copyKeysDataTo(RejectedStruct other) {
...
SelectedStruct Selected = new SelectedStruct();
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_1 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_1.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:2EqixISoYpVNeCa3MJZANwXVUvLJFpXvXsg5AZdroOres9g88sRQLFvC+Ro="));
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"agency_id\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"agency_id\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"agency_id\",\"talend.field.isKey\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"agency_name\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"agency_name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"agency_name\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"agency_url\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"agency_url\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"agency_url\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"agency_logo_url\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"agency_logo_url\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"agency_logo_url\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}",s);
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_3_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"agency_logo_url\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"agency_logo_url\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"agency_logo_url\",\"di.column.relatedEntity\":\"\"},{",s);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.addRow(new String[]{"agency_id","agency_name","agency_url","agency_logo_url",});        
 ...
 */
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"Selected");
					}
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.agency_name == null) ? 0 : this.agency_name.hashCode());
								
								result = prime * result + ((this.agency_url == null) ? 0 : this.agency_url.hashCode());
								
								result = prime * result + ((this.agency_logo_url == null) ? 0 : this.agency_logo_url.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									} else if (!this.agency_name.equals(other.agency_name))
									...
									} else if (!this.agency_url.equals(other.agency_url))
								 
										return false;
								
									if (this.agency_logo_url == null) {
										if (other.agency_logo_url != null) 
											return false;
								
									} else if (!this.agency_logo_url.equals(other.agency_logo_url))
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.setTableName("Rejected not in EU");
        util_tLogRow_1.addRow(new String[]{"agency_id","agency_name",});        
...
SelectedStruct Selected_tmp = new SelectedStruct();
...
java.net.URL url_tHttpRequest_1 = new java.net.URL("https://hrrykpvhpfemjrizhods.supabase.co/storage/v1/object/public/gtfs_data/latest/agencies.json");
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.agency_logo_url";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.agency_logo_url = value_tExtractJSONFields_1 == null ? 

		null

 : value_tExtractJSONFields_1.toString();
		} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_1) {
			row2.agency_logo_url = 
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.code_iso = row2.agency_state ;
								  ...
								  if(!tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.code_iso = '" + row3HashKey.code_iso + "'");
								} // G 071
...
Selected_tmp.agency_id = row2.agency_id ;
Selected_tmp.agency_name = row2.agency_name ;
Selected_tmp.agency_url = row2.agency_url ;
Selected_tmp.agency_logo_url = row2.agency_logo_url ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
Rejected_tmp.agency_id = row2.agency_id ;
Rejected_tmp.agency_name = row2.agency_name ;
...
if(Selected != null) { 
	...
	currentComponent="tUniqRow_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"Selected");
					}
					
row4 = null;			row5 = null;			
if(Selected.agency_id == null){
	finder_tUniqRow_1.agency_id = null;
}else{
	finder_tUniqRow_1.agency_id = Selected.agency_id.toLowerCase();
}
if(Selected.agency_name == null){
	finder_tUniqRow_1.agency_name = null;
}else{
	finder_tUniqRow_1.agency_name = Selected.agency_name.toLowerCase();
}
if(Selected.agency_url == null){
	finder_tUniqRow_1.agency_url = null;
}else{
	finder_tUniqRow_1.agency_url = Selected.agency_url.toLowerCase();
}
if(Selected.agency_logo_url == null){
	finder_tUniqRow_1.agency_logo_url = null;
}else{
	finder_tUniqRow_1.agency_logo_url = Selected.agency_logo_url.toLowerCase();
}	
...
if(Selected.agency_id == null){
	...
	new_tUniqRow_1.agency_id = Selected.agency_id.toLowerCase();
}
if(Selected.agency_name == null){
	new_tUniqRow_1.agency_name = null;
}else{
	new_tUniqRow_1.agency_name = Selected.agency_name.toLowerCase();
}
if(Selected.agency_url == null){
	new_tUniqRow_1.agency_url = null;
}else{
	new_tUniqRow_1.agency_url = Selected.agency_url.toLowerCase();
}
if(Selected.agency_logo_url == null){
	new_tUniqRow_1.agency_logo_url = null;
}else{
	new_tUniqRow_1.agency_logo_url = Selected.agency_logo_url.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row5 == null){ 
	
	row5 = new row5Struct();
}row5.agency_id = Selected.agency_id;			row5.agency_name = Selected.agency_name;			row5.agency_url = Selected.agency_url;			row5.agency_logo_url = Selected.agency_logo_url;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row4 == null){ 
	
	row4 = new row4Struct();
}				row4.agency_id = Selected.agency_id;			row4.agency_name = Selected.agency_name;			row4.agency_url = Selected.agency_url;			row4.agency_logo_url = Selected.agency_logo_url;			
	...
	currentComponent="tDBOutput_1";
        ...
        incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("agency_id") != null){
                    incomingEnforcer_tDBOutput_1.put("agency_id", row5.agency_id);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("agency_name") != null){
                    incomingEnforcer_tDBOutput_1.put("agency_name", row5.agency_name);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("agency_url") != null){
                    incomingEnforcer_tDBOutput_1.put("agency_url", row5.agency_url);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("agency_logo_url") != null){
                    incomingEnforcer_tDBOutput_1.put("agency_logo_url", row5.agency_logo_url);
                }
...
///////////////////////		
	    		...
	    		if(row4.agency_id != null) { //              
                 row_tLogRow_2[0]=    						    
				                String.valueOf(row4.agency_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(row4.agency_name != null) { //              
                 row_tLogRow_2[1]=    						    
				                String.valueOf(row4.agency_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(row4.agency_url != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(row4.agency_url)			
					          ;	
							
	    		} //			
    			   				
	    		if(row4.agency_logo_url != null) { //              
                 row_tLogRow_2[3]=    						    
				                String.valueOf(row4.agency_logo_url)			
					          ;	
...
if(Rejected != null) { 
	...
	currentComponent="tLogRow_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"Rejected");
					}
...
///////////////////////		
	    		...
	    		if(Rejected.agency_id != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(Rejected.agency_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(Rejected.agency_name != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(Rejected.agency_name)			
					          ;	
...
globalMap.put("tUniqRow_1_NB_DUPLICATES",nb_duplicates_tUniqRow_1);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"Selected");
			  	}
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_2 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_2.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:U2X21+56yICB0c8x/TuEfRxS3MVm9/aqN3Hh7JOKhWmon4MvXPkTbBprPrE="));
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.id_country = readString(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.id_country, dos, oos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("id_country="+id_country);
		sb.append(",name="+name);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row2,row3) outputs:(Selected,Rejected)
...
org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties props_tDBInput_1 =
        (org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties) def_tDBInput_1.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:lKVUkQMuv9YwFD+umr40poqG7zbK+RxgnZ61WfJ0j6GDBYcvqfyXSUmCMnE="));
 		                    ...
 		                    class SchemaSettingTool_tDBInput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"id_country\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"id_country\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"id_country\",\"talend.field.isKey\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
    ...
    for (; available_tDBInput_1; available_tDBInput_1 = reader_tDBInput_1.advance()) {
        ...
        outgoingEnforcer_tDBInput_1.setWrapped(factory_tDBInput_1.convertToAvro(data_tDBInput_1));
                Object columnValue_0_tDBInput_1 = outgoingEnforcer_tDBInput_1.get(0);
                        row3.id_country = (String) (columnValue_0_tDBInput_1);
                Object columnValue_1_tDBInput_1 = outgoingEnforcer_tDBInput_1.get(1);
                        row3.name = (String) (columnValue_1_tDBInput_1);
                Object columnValue_2_tDBInput_1 = outgoingEnforcer_tDBInput_1.get(2);
                        row3.code_iso = (String) (columnValue_2_tDBInput_1);
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.code_iso = row3.code_iso;
 ...
 */
    ...
    public static void main(String[] args){
        final AgenciesBackOnTrack AgenciesBackOnTrackClass = new AgenciesBackOnTrack();

        int exitCode = AgenciesBackOnTrackClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = AgenciesBackOnTrack.class.getClassLoader().getResourceAsStream("test_mspr/agenciesbackontrack_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = AgenciesBackOnTrack.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AgenciesBackOnTrack");
        }
...
/************************************************************************************************
 *     197761 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 avril 2026 09:54:26 CEST
 ************************************************************************************************/