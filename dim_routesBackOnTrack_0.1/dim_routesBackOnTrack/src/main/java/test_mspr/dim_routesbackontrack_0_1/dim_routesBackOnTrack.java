...
package test_mspr.dim_routesbackontrack_0_1;
...
/**
 * Job: dim_routesBackOnTrack Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class dim_routesBackOnTrack implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "dim_routesBackOnTrack";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dim_routesBackOnTrack.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dim_routesBackOnTrack.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class SourceStruct implements routines.system.IPersistableRow<SourceStruct> {
    final static byte[] commonByteArrayLock_TEST_MSPR_dim_routesBackOnTrack = new byte[0];
    static byte[] commonByteArray_TEST_MSPR_dim_routesBackOnTrack = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_MSPR_dim_routesBackOnTrack.length) {
				if(length < 1024 && commonByteArray_TEST_MSPR_dim_routesBackOnTrack.length == 0) {
   					commonByteArray_TEST_MSPR_dim_routesBackOnTrack = new byte[1024];
				} else {
   					commonByteArray_TEST_MSPR_dim_routesBackOnTrack = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_MSPR_dim_routesBackOnTrack, 0, length);
			strReturn = new String(commonByteArray_TEST_MSPR_dim_routesBackOnTrack, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_MSPR_dim_routesBackOnTrack) {
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_2 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_2.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:aBOloMoWtXtHXhor9+HCGPCumNEPseaOLVqBtLVPbaSlokzVolL0wCP2Z/U="));
...
StringBuilder result_tFixedFlowInput_1 = new StringBuilder();
	result_tFixedFlowInput_1.append("QmFja09uVHJhY2tyb3V0ZXM7Um91dGVzO0pTT04=");
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		synchronized(commonByteArrayLock_TEST_MSPR_dim_routesBackOnTrack) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.route_long_name = readString(dis);
					
					this.route_desc = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.route_long_name,dos);
					
					// String
				
						writeString(this.route_desc,dos);
    ...
    public String toString() {
		...
		sb.append(",route_desc="+route_desc);
...
public static class UnknownAngencyStruct implements routines.system.IPersistableRow<UnknownAngencyStruct> {
    final static byte[] commonByteArrayLock_TEST_MSPR_dim_routesBackOnTrack = new byte[0];
    static byte[] commonByteArray_TEST_MSPR_dim_routesBackOnTrack = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final UnknownAngencyStruct other = (UnknownAngencyStruct) obj;
	...
	public void copyDataTo(UnknownAngencyStruct other) {
	...
	public void copyKeysDataTo(UnknownAngencyStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(UnknownAngencyStruct other) {
...
UnknownAngencyStruct UnknownAngency = new UnknownAngencyStruct();
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_1 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_1.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:06rszeKITtBHfkxcfV5/z4pR7sHEiivnEQowKXSgMt4iFO+f7YVlBC9x508="));
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"agency_id\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"agency_id\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"agency_id\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"route_short_name\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"route_short_name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"route_short_name\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"route_long_name\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"route_long_name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"route_long_name\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"route_desc\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"route_desc\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"route_desc\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"countries\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"countries\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"countries\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"picture_url\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"picture_url\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"picture_url\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}",s);
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_3_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"picture_url\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"picture_url\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"picture_url\",\"di.column.relatedEntity\":\"\"},{",s);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"route_id","agency_id","route_short_name","route_long_name","route_desc","countries","is_active","picture_url",});        
		...
		class KeyStruct_tUniqRow_1 {
			...
			public int hashCode() {
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.agency_id == null) ? 0 : this.agency_id.hashCode());
								
								result = prime * result + ((this.route_short_name == null) ? 0 : this.route_short_name.hashCode());
								
								result = prime * result + ((this.route_long_name == null) ? 0 : this.route_long_name.hashCode());
								
								result = prime * result + ((this.route_desc == null) ? 0 : this.route_desc.hashCode());
								...
								result = prime * result + ((this.picture_url == null) ? 0 : this.picture_url.hashCode());
			...
			public boolean equals(Object obj) {
				...
				final KeyStruct_tUniqRow_1 other = (KeyStruct_tUniqRow_1) obj;
									...
									} else if (!this.agency_id.equals(other.agency_id))
								 
										return false;
								
									if (this.route_short_name == null) {
										if (other.route_short_name != null) 
											return false;
								
									} else if (!this.route_short_name.equals(other.route_short_name))
								 
										return false;
								
									if (this.route_long_name == null) {
										if (other.route_long_name != null) 
											return false;
								
									} else if (!this.route_long_name.equals(other.route_long_name))
								 
										return false;
								
									if (this.route_desc == null) {
										if (other.route_desc != null) 
											return false;
								
									} else if (!this.route_desc.equals(other.route_desc))
									...
									} else if (!this.picture_url.equals(other.picture_url))
 ...
 */
	...
	currentComponent="tLogRow_3";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"UnknownAngency");
					}
	...
	///////////////////////
        ...
        util_tLogRow_3.setTableName("UnknownAgency");
        util_tLogRow_3.addRow(new String[]{"route_id","route_short_name","countries",});        
...
UnknownAngencyStruct UnknownAngency_tmp = new UnknownAngencyStruct();
// ###############################
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_2.setTableName("UnknownTrip");
        util_tLogRow_2.addRow(new String[]{"route_id","route_short_name","countries",});        
...
java.net.URL url_tHttpRequest_1 = new java.net.URL("https://hrrykpvhpfemjrizhods.supabase.co/storage/v1/object/public/gtfs_data/latest/routes.json");
...
for(int i_tExtractJSONFields_1=0; isStructError_tExtractJSONFields_1 || (i_tExtractJSONFields_1 < resultset_tExtractJSONFields_1.size());i_tExtractJSONFields_1++){
	...
	try {
		...
		try {
				...
				row2.route_id = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.route_long_name";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.route_long_name = value_tExtractJSONFields_1 == null ? 

		null

 : value_tExtractJSONFields_1.toString();
		} catch (com.jayway.jsonpath.PathNotFoundException e_tExtractJSONFields_1) {
			row2.route_long_name = 

		null

;
		}
		jsonPath_tExtractJSONFields_1 = "$.route_desc";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.route_desc = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.countries";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.countries = value_tExtractJSONFields_1 == null ? 
...
;
		...
		try {
				...
				row2.is_active = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.picture";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.picture_url = value_tExtractJSONFields_1 == null ? 
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.agency_id = row2.agency_id ;
								  ...
								  if(!tHash_Lookup_row3.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.agency_id = '" + row3HashKey.agency_id + "'");
								} // G 071
...
// # Output table : 'out1'
out1_tmp.route_id = row2.route_id ;
out1_tmp.agency_id = row2.agency_id ;
out1_tmp.route_short_name = row2.route_short_name ;
out1_tmp.route_long_name = (row2.route_long_name == null || row2.route_long_name.equals("")) ? row2.agency_id + " " + row3.trip_name : row2.route_long_name ;
out1_tmp.route_desc = row2.route_desc ;
out1_tmp.countries = row2.countries ;
out1_tmp.is_active = row2.is_active ;
out1_tmp.picture_url = row2.picture_url ;
out1 = out1_tmp;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_1 ) {
UnknownTrip_tmp.route_id = row2.route_id ;
UnknownTrip_tmp.route_short_name = row2.route_short_name ;
UnknownTrip_tmp.countries = row2.countries ;
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row6HashKey.agency_id = out1.agency_id ;
								  ...
								  if(!tHash_Lookup_row6.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.agency_id = '" + row6HashKey.agency_id + "'");
								} // G 071
...
// # Output table : 'out2'
out2_tmp.route_id = out1.route_id ;
out2_tmp.agency_id = out1.agency_id ;
out2_tmp.route_short_name = out1.route_short_name ;
out2_tmp.route_long_name = out1.route_long_name ;
out2_tmp.route_desc = out1.route_desc ;
out2_tmp.countries = out1.countries ;
out2_tmp.is_active = out1.is_active ;
out2_tmp.picture_url = out1.picture_url ;
out2 = out2_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'UnknownAngency'
// # Filter conditions 
if( rejectedInnerJoin_tMap_3 ) {
UnknownAngency_tmp.route_id = out1.route_id ;
UnknownAngency_tmp.route_short_name = out1.route_short_name ;
UnknownAngency_tmp.countries = out1.countries ;
UnknownAngency = UnknownAngency_tmp;
} // closing filter/reject
// ###############################
...
row5 = null;			row4 = null;			
if(out2.route_id == null){
	finder_tUniqRow_1.route_id = null;
}else{
	finder_tUniqRow_1.route_id = out2.route_id.toLowerCase();
}
if(out2.agency_id == null){
	finder_tUniqRow_1.agency_id = null;
}else{
	finder_tUniqRow_1.agency_id = out2.agency_id.toLowerCase();
}
if(out2.route_short_name == null){
	finder_tUniqRow_1.route_short_name = null;
}else{
	finder_tUniqRow_1.route_short_name = out2.route_short_name.toLowerCase();
}
if(out2.route_long_name == null){
	finder_tUniqRow_1.route_long_name = null;
}else{
	finder_tUniqRow_1.route_long_name = out2.route_long_name.toLowerCase();
}
if(out2.route_desc == null){
	finder_tUniqRow_1.route_desc = null;
}else{
	finder_tUniqRow_1.route_desc = out2.route_desc.toLowerCase();
}
if(out2.countries == null){
	finder_tUniqRow_1.countries = null;
}else{
	finder_tUniqRow_1.countries = out2.countries.toLowerCase();
}
if(out2.is_active == null){
	finder_tUniqRow_1.is_active = null;
}else{
	finder_tUniqRow_1.is_active = out2.is_active.toLowerCase();
}
if(out2.picture_url == null){
	finder_tUniqRow_1.picture_url = null;
}else{
	finder_tUniqRow_1.picture_url = out2.picture_url.toLowerCase();
}	
...
if(out2.route_id == null){
	...
	new_tUniqRow_1.route_id = out2.route_id.toLowerCase();
}
if(out2.agency_id == null){
	new_tUniqRow_1.agency_id = null;
}else{
	new_tUniqRow_1.agency_id = out2.agency_id.toLowerCase();
}
if(out2.route_short_name == null){
	new_tUniqRow_1.route_short_name = null;
}else{
	new_tUniqRow_1.route_short_name = out2.route_short_name.toLowerCase();
}
if(out2.route_long_name == null){
	new_tUniqRow_1.route_long_name = null;
}else{
	new_tUniqRow_1.route_long_name = out2.route_long_name.toLowerCase();
}
if(out2.route_desc == null){
	new_tUniqRow_1.route_desc = null;
}else{
	new_tUniqRow_1.route_desc = out2.route_desc.toLowerCase();
}
if(out2.countries == null){
	new_tUniqRow_1.countries = null;
}else{
	new_tUniqRow_1.countries = out2.countries.toLowerCase();
}
if(out2.is_active == null){
	new_tUniqRow_1.is_active = null;
}else{
	new_tUniqRow_1.is_active = out2.is_active.toLowerCase();
}
if(out2.picture_url == null){
	new_tUniqRow_1.picture_url = null;
}else{
	new_tUniqRow_1.picture_url = out2.picture_url.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row4 == null){ 
	
	row4 = new row4Struct();
}row4.route_id = out2.route_id;			row4.agency_id = out2.agency_id;			row4.route_short_name = out2.route_short_name;			row4.route_long_name = out2.route_long_name;			row4.route_desc = out2.route_desc;			row4.countries = out2.countries;			row4.is_active = out2.is_active;			row4.picture_url = out2.picture_url;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row5 == null){ 
	
	row5 = new row5Struct();
}				row5.route_id = out2.route_id;			row5.agency_id = out2.agency_id;			row5.route_short_name = out2.route_short_name;			row5.route_long_name = out2.route_long_name;			row5.route_desc = out2.route_desc;			row5.countries = out2.countries;			row5.is_active = out2.is_active;			row5.picture_url = out2.picture_url;			
	...
	currentComponent="tDBOutput_1";
        ...
        incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("route_id") != null){
                    incomingEnforcer_tDBOutput_1.put("route_id", row4.route_id);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("agency_id") != null){
                    incomingEnforcer_tDBOutput_1.put("agency_id", row4.agency_id);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("route_short_name") != null){
                    incomingEnforcer_tDBOutput_1.put("route_short_name", row4.route_short_name);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("route_long_name") != null){
                    incomingEnforcer_tDBOutput_1.put("route_long_name", row4.route_long_name);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("route_desc") != null){
                    incomingEnforcer_tDBOutput_1.put("route_desc", row4.route_desc);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("countries") != null){
                    incomingEnforcer_tDBOutput_1.put("countries", row4.countries);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("is_active") != null){
                    incomingEnforcer_tDBOutput_1.put("is_active", row4.is_active);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("picture_url") != null){
                    incomingEnforcer_tDBOutput_1.put("picture_url", row4.picture_url);
                }
...
///////////////////////		
	    		...
	    		if(row5.route_id != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(row5.route_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(row5.agency_id != null) { //              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(row5.agency_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(row5.route_short_name != null) { //              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row5.route_short_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(row5.route_long_name != null) { //              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row5.route_long_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(row5.route_desc != null) { //              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row5.route_desc)			
					          ;	
							
	    		} //			
    			   				
	    		if(row5.countries != null) { //              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(row5.countries)			
					          ;	
							
	    		} //			
    			   				
	    		if(row5.is_active != null) { //              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row5.is_active)			
					          ;	
							
	    		} //			
    			   				
	    		if(row5.picture_url != null) { //              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(row5.picture_url)			
					          ;	
...
// Start of branch "UnknownAngency"
if(UnknownAngency != null) { 
	...
	currentComponent="tLogRow_3";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"UnknownAngency");
					}
...
///////////////////////		
	    		...
	    		if(UnknownAngency.route_id != null) { //              
                 row_tLogRow_3[0]=    						    
				                String.valueOf(UnknownAngency.route_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(UnknownAngency.route_short_name != null) { //              
                 row_tLogRow_3[1]=    						    
				                String.valueOf(UnknownAngency.route_short_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(UnknownAngency.countries != null) { //              
                 row_tLogRow_3[2]=    						    
				                String.valueOf(UnknownAngency.countries)			
					          ;	
...
///////////////////////		
	    		...
	    		if(UnknownTrip.route_id != null) { //              
                 row_tLogRow_2[0]=    						    
				                String.valueOf(UnknownTrip.route_id)			
					          ;	
							
	    		} //			
    			   				
	    		if(UnknownTrip.route_short_name != null) { //              
                 row_tLogRow_2[1]=    						    
				                String.valueOf(UnknownTrip.route_short_name)			
					          ;	
							
	    		} //			
    			   				
	    		if(UnknownTrip.countries != null) { //              
                 row_tLogRow_2[2]=    						    
				                String.valueOf(UnknownTrip.countries)			
					          ;	
...
///////////////////////    			
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"UnknownAngency");
			  	}
...
public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.agency_name = readString(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.agency_name, dos, oos);
    ...
    public int compareTo(row6Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.agency_id, other.agency_id);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tDBInput_2 - inputs:(after_tHttpRequest_1) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
			   		// linked node: tMap_3 - inputs:(out1,row6) outputs:(out2,UnknownAngency)
...
org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties props_tDBInput_2 =
        (org.talend.components.jdbc.tjdbcinput.TJDBCInputProperties) def_tDBInput_2.createRuntimeProperties();
 		                    ...
 		                    "SELECT agency_id, agency_name FROM dim_agencies");
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:FS1FkXOyr90SCpEEHnLFYadmibZiaQPNMm3nliKb1+RpI6mck5fLaBvm28Q="));
 		                    ...
 		                    class SchemaSettingTool_tDBInput_2_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"agency_id\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"id_trip\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"agency_id\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"agency_id\",\"talend.field.isKey\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"agency_name\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"trip_name\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"agency_name\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"agency_name\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"MAIN\"}",s);
 		                    ...
 		                    java.util.List<Object> tDBInput_2_trimTable_columnName = new java.util.ArrayList<Object>();
 		                            ...
 		                            tDBInput_2_trimTable_columnName.add("agency_id");
 		                            
 		                            tDBInput_2_trimTable_columnName.add("agency_name");
    ...
    for (; available_tDBInput_2; available_tDBInput_2 = reader_tDBInput_2.advance()) {
        ...
        outgoingEnforcer_tDBInput_2.setWrapped(factory_tDBInput_2.convertToAvro(data_tDBInput_2));
                Object columnValue_0_tDBInput_2 = outgoingEnforcer_tDBInput_2.get(0);
                        row6.agency_id = (String) (columnValue_0_tDBInput_2);
                Object columnValue_1_tDBInput_2 = outgoingEnforcer_tDBInput_2.get(1);
                        row6.agency_name = (String) (columnValue_1_tDBInput_2);
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.agency_id = row6.agency_id;
				
				row6_HashRow.agency_name = row6.agency_name;
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.id_trip = readString(dis,ois);
					
						this.trip_name = readString(dis,ois);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.id_trip, dos, oos);
					
						writeString(this.trip_name, dos, oos);
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		...
		synchronized(commonByteArrayLock_TEST_MSPR_dim_routesBackOnTrack) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.json_content = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.json_content,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("json_content="+json_content);
	    sb.append("]");
...
row3Struct row3 = new row3Struct();
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// source node:tExtractJSONFields_2 - inputs:(row7) outputs:(row3,row3) | target node:tAdvancedHash_row3 - inputs:(row3) outputs:()
...
Object filenameOrStream_tFileInputJSON_2 = null;
        try {
            filenameOrStream_tFileInputJSON_2 = "C:/Users/lucie/Desktop/Cours/B3/MSPR/night-train-data/data/latest/trips.json";
	...
	try{
				...
				try {
				       ...
				       value_tFileInputJSON_2 = compiledJsonPath_tFileInputJSON_2.read(row_tFileInputJSON_2);
						...
						row7.json_content = value_tFileInputJSON_2 == null ? 
...
if(row7 != null) { 
	...
	currentComponent="tExtractJSONFields_2";
            ...
            if(row7.json_content!=null){// C_01
                jsonStr_tExtractJSONFields_2 = row7.json_content.toString();
...
for(int i_tExtractJSONFields_2=0; isStructError_tExtractJSONFields_2 || (i_tExtractJSONFields_2 < resultset_tExtractJSONFields_2.size());i_tExtractJSONFields_2++){
	...
	try {
		...
		try {
				...
				row3.id_trip = value_tExtractJSONFields_2 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_2 = "$.agency_id";
		compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
		...
		try {
				...
				row3.agency_id = value_tExtractJSONFields_2 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_2 = "$.trip_short_name";
		compiledJsonPath_tExtractJSONFields_2 = jsonPathCache_tExtractJSONFields_2.getCompiledJsonPath(jsonPath_tExtractJSONFields_2);
		...
		try {
				...
				row3.trip_name = value_tExtractJSONFields_2 == null ? 
...
if(row3 != null) { 
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.id_trip = row3.id_trip;
				
				row3_HashRow.agency_id = row3.agency_id;
				
				row3_HashRow.trip_name = row3.trip_name;
 ...
 */
    ...
    public static void main(String[] args){
        final dim_routesBackOnTrack dim_routesBackOnTrackClass = new dim_routesBackOnTrack();

        int exitCode = dim_routesBackOnTrackClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dim_routesBackOnTrack.class.getClassLoader().getResourceAsStream("test_mspr/dim_routesbackontrack_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dim_routesBackOnTrack.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_routesBackOnTrack");
        }
...
/************************************************************************************************
 *     269415 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 avril 2026 09:58:19 CEST
 ************************************************************************************************/