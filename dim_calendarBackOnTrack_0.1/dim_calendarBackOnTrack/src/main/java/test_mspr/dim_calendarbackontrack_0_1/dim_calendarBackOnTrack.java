...
package test_mspr.dim_calendarbackontrack_0_1;
...
/**
 * Job: dim_calendarBackOnTrack Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class dim_calendarBackOnTrack implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "dim_calendarBackOnTrack";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				dim_calendarBackOnTrack.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dim_calendarBackOnTrack.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
    final static byte[] commonByteArrayLock_TEST_MSPR_dim_calendarBackOnTrack = new byte[0];
    static byte[] commonByteArray_TEST_MSPR_dim_calendarBackOnTrack = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_MSPR_dim_calendarBackOnTrack.length) {
				if(length < 1024 && commonByteArray_TEST_MSPR_dim_calendarBackOnTrack.length == 0) {
   					commonByteArray_TEST_MSPR_dim_calendarBackOnTrack = new byte[1024];
				} else {
   					commonByteArray_TEST_MSPR_dim_calendarBackOnTrack = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_MSPR_dim_calendarBackOnTrack, 0, length);
			strReturn = new String(commonByteArray_TEST_MSPR_dim_calendarBackOnTrack, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_MSPR_dim_calendarBackOnTrack) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.monday = dis.readInt();
					
			        this.tuesday = dis.readInt();
					
			        this.wednesday = dis.readInt();
					
			        this.thursday = dis.readInt();
					
			        this.friday = dis.readInt();
					
			        this.saturday = dis.readInt();
					
			        this.sunday = dis.readInt();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// int
		            	...
		            	dos.writeInt(this.monday);
					
					// int
				
		            	dos.writeInt(this.tuesday);
					
					// int
				
		            	dos.writeInt(this.wednesday);
					
					// int
				
		            	dos.writeInt(this.thursday);
					
					// int
				
		            	dos.writeInt(this.friday);
					
					// int
				
		            	dos.writeInt(this.saturday);
					
					// int
				
		            	dos.writeInt(this.sunday);
    ...
    public String toString() {
		...
		sb.append(",monday="+String.valueOf(monday));
		sb.append(",tuesday="+String.valueOf(tuesday));
		sb.append(",wednesday="+String.valueOf(wednesday));
		sb.append(",thursday="+String.valueOf(thursday));
		sb.append(",friday="+String.valueOf(friday));
		sb.append(",saturday="+String.valueOf(saturday));
		sb.append(",sunday="+String.valueOf(sunday));
		...
		synchronized(commonByteArrayLock_TEST_MSPR_dim_calendarBackOnTrack) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.monday = readString(dis);
					
					this.tuesday = readString(dis);
					
					this.wednesday = readString(dis);
					
					this.thursday = readString(dis);
					
					this.friday = readString(dis);
					
					this.saturday = readString(dis);
					
					this.sunday = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.monday,dos);
					
					// String
				
						writeString(this.tuesday,dos);
					
					// String
				
						writeString(this.wednesday,dos);
					
					// String
				
						writeString(this.thursday,dos);
					
					// String
				
						writeString(this.friday,dos);
					
					// String
				
						writeString(this.saturday,dos);
					
					// String
				
						writeString(this.sunday,dos);
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_1 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_1.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:AehrFnmQ8gSgRkEjtpDnS2W34c/krgPbSoKeeAXWSMORYOASFZfOohgN+oc="));
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"service_id\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"service_id\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"service_id\",\"talend.field.isKey\":\"true\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"monday\",\"type\":\"int\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"monday\",\"di.column.talendType\":\"id_Integer\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"monday\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"tuesday\",\"type\":\"int\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"tuesday\",\"di.column.talendType\":\"id_Integer\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"tuesday\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"wednesday\",\"type\":\"int\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"wednesday\",\"di.column.talendType\":\"id_Integer\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"wednesday\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"thursday\",\"type\":\"int\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"thursday\",\"di.column.talendType\":\"id_Integer\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"thursday\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"friday\",\"type\":\"int\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"friday\",\"di.column.talendType\":\"id_Integer\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"friday\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"saturday\",\"type\":\"int\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"saturday\",\"di.column.talendType\":\"id_Integer\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"saturday\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"sunday\",\"type\":\"int\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"sunday\",\"di.column.talendType\":\"id_Integer\",\"talend.field.pattern\":\"\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"sunday\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"start_date\",\"type\":{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"start_date\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"dd-MM-yyyy\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"start_date\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"end_date\",\"type\":{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"end_date\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"dd-MM-yyyy\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"end_date\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"tDBOutput_1\",\"di.table.label\":\"tDBOutput_1\"}",s);
 		                    ...
 		                    class SchemaSettingTool_tDBOutput_1_3_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"end_date\",\"type\":{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"end_date\",\"di.column.talendType\":\"id_Date\",\"talend.field.pattern\":\"dd-MM-yyyy\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"end_date\",\"di.column.relatedEntity\":\"\"},{",s);
 ...
 */
	...
	///////////////////////
        ...
        util_tLogRow_1.addRow(new String[]{"service_id","monday","tuesday","wednesday","thursday","friday","saturday","sunday","start_date","end_date",});        
				...
				if (this.hashCodeDirty) {
					...
					int result = DEFAULT_HASHCODE;
								...
								result = prime * result + ((this.service_id == null) ? 0 : this.service_id.hashCode());
									...
									result = prime * result + (int) this.monday;
									
									result = prime * result + (int) this.tuesday;
									
									result = prime * result + (int) this.wednesday;
									
									result = prime * result + (int) this.thursday;
									
									result = prime * result + (int) this.friday;
									
									result = prime * result + (int) this.saturday;
									
									result = prime * result + (int) this.sunday;
...
java.net.URL url_tHttpRequest_1 = new java.net.URL("https://hrrykpvhpfemjrizhods.supabase.co/storage/v1/object/public/gtfs_data/latest/calendar.json");
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.monday";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.monday = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.tuesday";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.tuesday = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.wednesday";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.wednesday = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.thursday";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.thursday = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.friday";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.friday = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.saturday";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.saturday = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.sunday";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.sunday = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.start_date";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.start_date = value_tExtractJSONFields_1 == null ? 
...
;
		...
		jsonPath_tExtractJSONFields_1 = "$.end_date";
		compiledJsonPath_tExtractJSONFields_1 = jsonPathCache_tExtractJSONFields_1.getCompiledJsonPath(jsonPath_tExtractJSONFields_1);
		...
		try {
				...
				row2.end_date = value_tExtractJSONFields_1 == null ? 
...
out1_tmp.monday = (row2.monday == null || row2.monday.isEmpty()) ? 0 : (int) Float.parseFloat(row2.monday.replace(",", ".")) ;
out1_tmp.tuesday = (row2.tuesday == null || row2.tuesday.isEmpty()) ? 0 : (int) Float.parseFloat(row2.tuesday.replace(",", ".")) ;
out1_tmp.wednesday = (row2.wednesday == null || row2.wednesday.isEmpty()) ? 0 : (int) Float.parseFloat(row2.wednesday.replace(",", ".")) ;
out1_tmp.thursday = (row2.thursday == null || row2.thursday.isEmpty()) ? 0 : (int) Float.parseFloat(row2.thursday.replace(",", ".")) ;
out1_tmp.friday = (row2.friday == null || row2.friday.isEmpty()) ? 0 : (int) Float.parseFloat(row2.friday.replace(",", ".")) ;
out1_tmp.saturday = (row2.saturday == null || row2.saturday.isEmpty()) ? 0 : (int) Float.parseFloat(row2.saturday.replace(",", ".")) ;
out1_tmp.sunday = (row2.sunday == null || row2.sunday.isEmpty()) ? 0 : (int) Float.parseFloat(row2.sunday.replace(",", ".")) ;
out1_tmp.start_date = // On vérifie si c'est vide ou nul
(row2.start_date == null || row2.start_date.equals("") || row2.start_date.equals("0")) ? null : 
// Si c'est le format long ISO (contient un T)
(row2.start_date.contains("T") ? 
    TalendDate.parseDate("yyyy-MM-dd'T'HH:mm:ss", row2.start_date.substring(0,19)) : 
    // Sinon on traite comme le format compact yyyyMMdd
    TalendDate.parseDate("yyyyMMdd", row2.start_date)) ;
out1_tmp.end_date = // On vérifie si c'est vide ou nul
(row2.end_date == null || row2.end_date.equals("") || row2.end_date.equals("0")) ? null : 
// Si c'est le format long ISO (contient un T)
(row2.end_date.contains("T") ? 
    TalendDate.parseDate("yyyy-MM-dd'T'HH:mm:ss", row2.end_date.substring(0,19)) : 
    // Sinon on traite comme le format compact yyyyMMdd
    TalendDate.parseDate("yyyyMMdd", row2.end_date)) ;
out1 = out1_tmp;
// ###############################
...
row3 = null;			row4 = null;			
if(out1.service_id == null){
	finder_tUniqRow_1.service_id = null;
}else{
	finder_tUniqRow_1.service_id = out1.service_id.toLowerCase();
}
finder_tUniqRow_1.monday = out1.monday;
finder_tUniqRow_1.tuesday = out1.tuesday;
finder_tUniqRow_1.wednesday = out1.wednesday;
finder_tUniqRow_1.thursday = out1.thursday;
finder_tUniqRow_1.friday = out1.friday;
finder_tUniqRow_1.saturday = out1.saturday;
finder_tUniqRow_1.sunday = out1.sunday;
finder_tUniqRow_1.start_date = out1.start_date;
finder_tUniqRow_1.end_date = out1.end_date;	
...
if(out1.service_id == null){
	...
	new_tUniqRow_1.service_id = out1.service_id.toLowerCase();
}
new_tUniqRow_1.monday = out1.monday;
new_tUniqRow_1.tuesday = out1.tuesday;
new_tUniqRow_1.wednesday = out1.wednesday;
new_tUniqRow_1.thursday = out1.thursday;
new_tUniqRow_1.friday = out1.friday;
new_tUniqRow_1.saturday = out1.saturday;
new_tUniqRow_1.sunday = out1.sunday;
new_tUniqRow_1.start_date = out1.start_date;
new_tUniqRow_1.end_date = out1.end_date;
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row4 == null){ 
	
	row4 = new row4Struct();
}row4.service_id = out1.service_id;			row4.monday = out1.monday;			row4.tuesday = out1.tuesday;			row4.wednesday = out1.wednesday;			row4.thursday = out1.thursday;			row4.friday = out1.friday;			row4.saturday = out1.saturday;			row4.sunday = out1.sunday;			row4.start_date = out1.start_date;			row4.end_date = out1.end_date;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row3 == null){ 
	
	row3 = new row3Struct();
}				row3.service_id = out1.service_id;			row3.monday = out1.monday;			row3.tuesday = out1.tuesday;			row3.wednesday = out1.wednesday;			row3.thursday = out1.thursday;			row3.friday = out1.friday;			row3.saturday = out1.saturday;			row3.sunday = out1.sunday;			row3.start_date = out1.start_date;			row3.end_date = out1.end_date;			
	...
	currentComponent="tDBOutput_1";
        ...
        incomingEnforcer_tDBOutput_1.createNewRecord();
                ...
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("service_id") != null){
                    incomingEnforcer_tDBOutput_1.put("service_id", row4.service_id);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("monday") != null){
                    incomingEnforcer_tDBOutput_1.put("monday", row4.monday);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("tuesday") != null){
                    incomingEnforcer_tDBOutput_1.put("tuesday", row4.tuesday);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("wednesday") != null){
                    incomingEnforcer_tDBOutput_1.put("wednesday", row4.wednesday);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("thursday") != null){
                    incomingEnforcer_tDBOutput_1.put("thursday", row4.thursday);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("friday") != null){
                    incomingEnforcer_tDBOutput_1.put("friday", row4.friday);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("saturday") != null){
                    incomingEnforcer_tDBOutput_1.put("saturday", row4.saturday);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("sunday") != null){
                    incomingEnforcer_tDBOutput_1.put("sunday", row4.sunday);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("start_date") != null){
                    incomingEnforcer_tDBOutput_1.put("start_date", row4.start_date);
                }
                //skip the put action if the input column doesn't appear in component runtime schema
                if (incomingEnforcer_tDBOutput_1.getRuntimeSchema().getField("end_date") != null){
                    incomingEnforcer_tDBOutput_1.put("end_date", row4.end_date);
                }
...
///////////////////////		
	    		...
	    		if(row3.service_id != null) { //              
                 row_tLogRow_1[0]=    						    
				                String.valueOf(row3.service_id)			
					          ;	
							
	    		} //			
    			              
                 row_tLogRow_1[1]=    						    
				                String.valueOf(row3.monday)			
					          ;	
										
    			              
                 row_tLogRow_1[2]=    						    
				                String.valueOf(row3.tuesday)			
					          ;	
										
    			              
                 row_tLogRow_1[3]=    						    
				                String.valueOf(row3.wednesday)			
					          ;	
										
    			              
                 row_tLogRow_1[4]=    						    
				                String.valueOf(row3.thursday)			
					          ;	
										
    			              
                 row_tLogRow_1[5]=    						    
				                String.valueOf(row3.friday)			
					          ;	
										
    			              
                 row_tLogRow_1[6]=    						    
				                String.valueOf(row3.saturday)			
					          ;	
										
    			              
                 row_tLogRow_1[7]=    						    
				                String.valueOf(row3.sunday)			
					          ;	
										
    			   				
	    		if(row3.start_date != null) { //              
                 row_tLogRow_1[8]=    						
								FormatterUtils.format_Date(row3.start_date, "dd-MM-yyyy")
					          ;	
	    		...
	    		if(row3.end_date != null) { //              
                 row_tLogRow_1[9]=    						
								FormatterUtils.format_Date(row3.end_date, "dd-MM-yyyy")
					          ;	
...
org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties props_tDBOutput_2 =
        (org.talend.components.jdbc.tjdbcoutput.TJDBCOutputProperties) def_tDBOutput_2.createRuntimeProperties();
 		                    ...
 		                    "postgres.hrrykpvhpfemjrizhods");
 		                        ...
 		                        routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tyEQ7MvPQmr4qV2Egqg8DAvpVU3kjV9zwbJKAkyfLuwnPkKpTBwKarnMUxM="));
...
StringBuilder result_tFixedFlowInput_1 = new StringBuilder();
	result_tFixedFlowInput_1.append("QmFja09uVHJhY2tBZ2VuY2llcztBZ2VuY2llcztKU09O");
 ...
 */
    ...
    public static void main(String[] args){
        final dim_calendarBackOnTrack dim_calendarBackOnTrackClass = new dim_calendarBackOnTrack();

        int exitCode = dim_calendarBackOnTrackClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dim_calendarBackOnTrack.class.getClassLoader().getResourceAsStream("test_mspr/dim_calendarbackontrack_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dim_calendarBackOnTrack.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_calendarBackOnTrack");
        }
...
/************************************************************************************************
 *     175522 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 avril 2026 09:57:17 CEST
 ************************************************************************************************/